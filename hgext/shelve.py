...
class shelvedfile(object):
    ...
    def writebundle(self, bases, node):
        ...
        outgoing = discovery.outgoing(
            self.repo, missingroots=bases, missingheads=[node]
        )
        cg = changegroup.makechangegroup(self.repo, outgoing, cgversion, "shelve")
...
def unshelveabort(ui, repo, state, opts):
    ...
    with repo.lock():
        try:
            ...
            repair.strip(ui, repo, state.nodestoremove, backup=False, topic="shelve")
        finally:
