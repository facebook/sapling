// @generated SignedSource<<3f380e49d1fde451fc3b83f00d2b6d6f>>
// @sync-source-commit <<5450566373c43976066fb096c991510cfcd756a9>>
...
union LoadSheddingMetric {
  ...
  // Top client memory attribution. Reads the fb303 counter specified in
  // `metric`, but only returns a value if the requesting client is the top
  // memory consumer; otherwise the rule is skipped. The LoadShedLimit.limit
  // field acts as the threshold for the metric.
  3: TopClient top_client;
}

@rust.Exhaustive
struct TopClient {
  // The fb303 counter to read (e.g. "container_memory_usage_percent.avg.10").
  1: string metric;
}
