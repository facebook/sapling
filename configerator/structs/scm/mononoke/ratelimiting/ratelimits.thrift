// @generated SignedSource<<ed11fd41379afb764cd26c1441c2b927>>
...
union Target {
  ...
  // All must be present for the rule to apple
  7: list<string> identities;
}

// We do not want static sliced to use other statis slices as a target.
...
struct RateLimit {
  ...
  // New style metric
  4: optional FciMetric fci_metric;
}
