// @generated SignedSource<<97b9bc361aa7a363f129ea6aa4dd0e38>>
...
struct RawDerivedDataTypesConfig {
  ...
  7: optional i16 deleted_manifest_version,
} (rust.exhaustive)
...
struct RawHookConfig {
    ...
    11: optional map<string, list<i64>> (rust.type = "HashMap") config_int_64_lists,
} (rust.exhaustive)
...
struct RawSegmentedChangelogConfig {
    ...
    10: list<RawSegmentedChangelogHeadConfig> extra_heads_to_include_in_background_jobs,
} (rust.exhaustive)
