// @generated SignedSource<<d54dc5433ee93086906a166847c69020>>
...
struct RawRestrictedPathsConfig {
  ...
  // Outer list = OR logic (any condition matching enables enforcement).
  // If empty/None, enforcement is disabled (logging only).
  5: optional list<RawEnforcementCondition> enforcement_conditions;
