// @generated SignedSource<<8d4f30ecf1277aa50b8783862102bdef>>
...
struct QuickRepoDefinition {
  ...
  18: optional bool disable_all_hooks;
...
struct RawEnforcementCondition {
  ...
  2: optional string sandcastle_alias;
  // Client main ID to match (exact match, e.g., "user:username")
  3: optional string client_main_id;
}
