// @generated SignedSource<<4aa2cf5c6a86785202a841e1368cb84c>>
...
struct RawRestrictedPathsConfig {
  ...
  // Hex-encoded manifest IDs known to collide between restricted and
  // unrestricted paths. A genuine collision is content-based and so produces the
  // same hash across every manifest type, so list each colliding ID here
  // regardless of manifest type.
  15: optional list<string> manifest_id_denylist;
}
