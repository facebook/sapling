// @generated SignedSource<<76b7520b6b636017500c99c3af75ddc1>>
...
struct RawDerivedDataConfig {
  ...
  /// Staged derivation configuration per derived data type name.
  13: optional map<string, RawStagedDerivationTypeConfig> staged_derivation;
}
...
@rust.Exhaustive
struct RawManifestStagedDerivationConfig {
  /// The path prefix this stage is responsible for.
  1: string path;
}

union RawStagedDerivationStageTypeConfig {
  1: RawManifestStagedDerivationConfig manifest;
}

@rust.Exhaustive
struct RawStagedDerivationStageConfig {
  ...
  3: RawStagedDerivationStageTypeConfig type_config;
}

@rust.Exhaustive
struct RawStagedDerivationTypeConfig {
  /// Bookmarks to use staged derivation for.
  1: list<string> bookmarks;
  /// Map from stage ID to stage config. Must form a DAG.
  2: map<string, RawStagedDerivationStageConfig> stages;
}
