// @generated SignedSource<<c9aefbc4e2c266a90a68c229a5d1fe31>>
...
struct RawOssDbRemote {
  ...
  2: i16 port;
  3: string user;
  4: string secret_name;
  5: string database;
  6: string secret_group;
...
typedef map<string, RawAclRegionConfig> (
  rust.type = "HashMap",
) map_string_RawAclRegionConfig_3881
typedef map<string, RawCommitSyncConfig> (
  rust.type = "HashMap",
) map_string_RawCommitSyncConfig_4989
typedef map<string, RawRepoConfig> (
  rust.type = "HashMap",
) map_string_RawRepoConfig_815
typedef map<string, RawRepoDefinition> (
  rust.type = "HashMap",
) map_string_RawRepoDefinition_9793
typedef map<string, RawStorageConfig> (
  rust.type = "HashMap",
) map_string_RawStorageConfig_2830
typedef map<string, i32> (rust.type = "HashMap") map_string_i32_6602
typedef map<string, i64> (rust.type = "HashMap") map_string_i64_6128
typedef map<string, list<i32>> (rust.type = "HashMap") map_string_list_i32_8462
typedef map<string, list<i64>> (rust.type = "HashMap") map_string_list_i64_8629
typedef map<string, list<string>> (
  rust.type = "HashMap",
) map_string_list_string_6265
typedef map<string, string> (rust.type = "HashMap") map_string_string_6987
