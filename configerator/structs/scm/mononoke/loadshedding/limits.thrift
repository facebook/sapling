// @generated SignedSource<<7ab6ac63b6aa20d8e4145c1bad5243fa>>
...
struct StaticSlicedRateLimits {
    // First matching limit will apply.
    1: list<StaticSlicedRateLimit> limits;
...
struct RateLimits {
  ...
  // Consistent percentage of rate limitted tiers (specified as identity subsets)
  4: optional StaticSlicedRateLimits static_sliced_rate_limits;
