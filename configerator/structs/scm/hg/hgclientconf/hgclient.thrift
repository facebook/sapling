// @generated SignedSource<<9e614a82b6583b41c2d9328da08e9a34>>
...
//
// Source: https://www.internalfb.com/code/configerator/[master]/source/scm/hg/hgclientconf/hgclient.thrift
...
// Represents an environment variable name and the expected value it must be set to.
//
// This is for adhoc debugging when it isn't easy to control CLI args or
// config files. Do not use for rollouts.
struct EnvVar {
  // The name of the environment variable to check.
  1: string name;
  // The exact value the environment variable must be set to. The check is
  // case-sensitive and the variable must be set (an unset variable never
  // matches, even when value is the empty string).
  2: string value;
}
...
union Condition {
  ...
  17: list<ACL> acls;
  // True if the named environment variable is set to the given value on the
  // client. Useful for gating configs on caller-specific environment markers
  // (e.g., a script that exports a flag before invoking sl).
  18: EnvVar env_var;
}
