...
location (so the generaldelta bit isn't stripped before the comparison)
  ...
  hgext.hgsql.CorruptionException: revision offset doesn't match prior length (12884967424 offset vs 3 length): data/z.i
...
# Attempt to pull new commit should fail because base rev is wrong due to reordering
  ...
  hgext.hgsql.CorruptionException: expected node d34c38483be9d08f205eaae60c380a29b48e0189 at rev 1 of 00changelog.i but found bc3a71defa4a8fb6e8e5c192c02a26d94853d281
