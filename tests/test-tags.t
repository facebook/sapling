...
Tag cache debug info written to blackbox log
  ...
  b9154636be93 tip
  $ hg blackbox -l 6
  1970/01/01 00:00:00 bob @(unknown) (5000)> identify
...
Merge the two heads:
  ...
  $ hg blackbox -l3
  1970/01/01 00:00:00 bob @(unknown) (5000)> merge 1
  ...
  1970/01/01 00:00:00 bob @(unknown) (5000)> blackbox -l3
  $ hg id
...
Missing tags2* files means the cache wasn't written through the normal mechanism.
  ...
  $ ls tagsclient/.hg/cache | grep -v check
  hgtagsfnodes1
