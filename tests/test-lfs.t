...
# Check the blobstore is populated
  ...
  .hg/cache/localblobstore/f1
  .hg/cache/localblobstore/f1/1e77c257047a398492d8d6cb9f6acf3aa7c4384bb23080b43546053e183e4b

# Check the blob stored contains the actual contents of the file
  $ cat .hg/cache/localblobstore/f1/1e77c257047a398492d8d6cb9f6acf3aa7c4384bb23080b43546053e183e4b
...
# Check blobstore could be an absolute path outside repo vfs:
  ...
  $ [ -f $TESTTMP/global-store/f1/1e77c257047a398492d8d6cb9f6acf3aa7c4384bb23080b43546053e183e4b ]
...
# Test bypass
  ...
  $ hg cat -r tip large --config lfs.url=file:$TESTTMP/404 --config lfs.blobstore=cache/404
  abort: No such file or directory: $TESTTMP/404/8e/92251415339ae9b148c8da89ed5ec665905166a1ab11b09dca8fad83344738
  [255]

  $ hg cat -r tip large --config lfs.url=file:$TESTTMP/404 --config lfs.blobstore=cache/404 --config lfs.bypass=1
  version https://git-lfs.github.com/spec/v1
  oid sha256:8e92251415339ae9b148c8da89ed5ec665905166a1ab11b09dca8fad83344738
  size 39
  x-is-binary 0
