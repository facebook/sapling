...
(The writing "no-che?k-code" is for not skipping this file when checking.)
  ...
  Skipping tests/hgsubversion/comprehensive/test_custom_layout.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_obsstore_on.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_rebuildmeta.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_sqlite_revmap.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_stupid_pull.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_updatemeta.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/comprehensive/test_verify_and_startrev.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/fixtures/rsvn.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/run.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_externals.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_branches.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_command.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_command_regexes.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_exec.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_mappings.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_fetch_symlinks.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_push_command.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_push_dirs.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_push_renames.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_single_dir_clone.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_single_dir_push.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_svn_pre_commit_hooks.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_svnwrap.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_tags.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_template_keywords.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_urls.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_util.py it has no-che?k-code (glob)
  Skipping tests/hgsubversion/test_utility_commands.py it has no-che?k-code (glob)
