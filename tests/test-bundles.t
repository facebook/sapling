...
Unbundling a shallow bundle
  ...
  saved backup bundle to $TESTTMP/shallow/.hg/strip-backup/66ee28d0328c-backup.hg
  1 files fetched over 1 fetches - (1 misses, 0.00% hit ratio) over *s (glob)
  $ hg unbundle .hg/strip-backup/66ee28d0328c-backup.hg
  adding changesets
  adding manifests
  adding file changes
...
Pulling from a shallow bundle
  ...
  $ hg strip -r 66ee28d0328c
  saved backup bundle to $TESTTMP/shallow/.hg/strip-backup/66ee28d0328c-backup.hg
  $ hg pull -r 66ee28d0328c .hg/strip-backup/66ee28d0328c-backup.hg
  pulling from .hg/strip-backup/66ee28d0328c-backup.hg
