...
outputs, which should be fixed later.
  ...
  tests/test-fb-hgext-revisionstore-datastore.py:*: symbol import follows non-symbol import: hgext.remotefilelog.datapack (glob)
  ...
  tests/test-fb-hgext-revisionstore-datastore.py:*: symbol import follows non-symbol import: hgext.remotefilelog.contentstore (glob)
  tests/test-fb-hgext-revisionstore-datastore.py:*: symbol import follows non-symbol import: mercurial.node (glob)
