  ...
  return (
    <Box display="flex" flexDirection="column" height="100vh">
      ...
      <Box flex="1 1 auto" overflowY="auto">
        <Box margin="auto" width={800} paddingY={2}>
          ...
          <Box>
            ...
            . For example, you may want to deploy your own instance of ReviewStack that is hardcoded
            to work with your GitHub Enterprise instance combined with an in-house SSO login flow.
            The codebase is designed so that the ReviewStack UI can be used as a reusable React
            component with minimal dependencies on the host environment.
          </Box>
        </Box>
      </Box>
      <Footer />
