...
class StandardLayout(base.BaseLayout):
    ...
    def __init__(self, meta):
        ...
        # its last slash
        meta._gen_cachedconfig(
            "branchdir",
            "branches",
            pre=lambda x: "/".join(p for p in x.split("/") if p) + "/",
        )
        ...
        meta._gen_cachedconfig(
            ...
            "tag_locations",
            "tagpaths",
            lambda x: list(reversed(sorted(x))),
        )
    ...
    def remotepath(self, branch, subdir="/"):
        ...
        if branch and branch != "default":
            if branch.startswith("../"):
                ...
                branchpath = "".join((self.meta.branchdir, branch, self.meta.infix))
