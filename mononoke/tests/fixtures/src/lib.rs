...
pub mod linear {
    ...
    pub fn initrepo(fb: FacebookInit, blobrepo: &BlobRepo) {
        ...
        create_bonsai_changeset_from_test_data(fb, blobrepo.clone(), files, commit_metadata);
    ...
    pub fn getrepo(fb: FacebookInit) -> BlobRepo {
        getrepo_with_id(fb, RepositoryId::new(0))
    }

    pub fn getrepo_with_id(fb: FacebookInit, id: RepositoryId) -> BlobRepo {
        let blobrepo = blobrepo_factory::new_memblob_empty_with_id(None, id).unwrap();
        initrepo(fb, &blobrepo);
        blobrepo
    }
}
...
pub mod many_files_dirs {
    ...
    pub fn getrepo(fb: FacebookInit) -> BlobRepo {
        getrepo_with_id(fb, RepositoryId::new(1))
    }
...
mod test {
    ...
    fn test_unshared_merge_even(fb: FacebookInit) {
        async_unit::tokio_unit_test(move || {
            unshared_merge_even::getrepo(fb);
        })
    }
    ...
    fn test_unshared_merge_uneven(fb: FacebookInit) {
        async_unit::tokio_unit_test(move || {
            unshared_merge_uneven::getrepo(fb);
        })
    }
