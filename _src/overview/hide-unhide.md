...
* Many commands work even on hidden commits. For instance, `sl show COMMIT` will let you to inspect a commit before unhiding it. You can even checkout a hidden commit to temporarily work with it.
