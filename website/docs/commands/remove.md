...
<!--
  @generated SignedSource<<4b46286f21826d95f4fee18055b91f97>>
...
(as reported by `sl status`). The actions are Warn, Remove
...
`sl remove` never deletes files in Added [A] state from the
