...
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(88019);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35417);
...
const draw = function(text, id, version, diagObj) {
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "millisecond":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMillisecond.every */ .U8T.every(every));
          break;
        case "second":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSecond.every */ .S1K.every(every));
          break;
        case "minute":
    ...
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      ...
      if (resultTickInterval !== null) {
        ...
        switch (interval) {
          case "millisecond":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMillisecond.every */ .U8T.every(every));
            break;
          case "second":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSecond.every */ .S1K.every(every));
            break;
          case "minute":
