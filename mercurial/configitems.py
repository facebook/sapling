...
coreconfigitem("convert", "cvsps.mergefrom", default=None)
coreconfigitem("convert", "cvsps.mergeto", default=None)
...
coreconfigitem("experimental", "evolution", default=list)
coreconfigitem(
    "experimental",
...
coreconfigitem("experimental", "revlogv2", default=None)
...
coreconfigitem("format", "usetreestate", default=False)
...
coreconfigitem("server", "concurrent-push-mode", default="strict")
...
coreconfigitem("ui", "checkheads", default=True)
...
coreconfigitem("ui", "gitignore", default=False)
coreconfigitem("ui", "graphnodetemplate", default=None)
coreconfigitem("ui", "hgignore", default=True)
