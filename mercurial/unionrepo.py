    ...
    def revdiff(self, rev1, rev2):
        ...
        if rev1 > self.repotiprev and rev2 > self.repotiprev:
            return self.revlog2.revdiff(
                self.revlog2.rev(self.node(rev1)), self.revlog2.rev(self.node(rev2))
            )
...
class unionchangelog(unionrevlog, changelog.changelog):
    def __init__(self, opener, opener2):
        ...
        unionrevlog.__init__(self, opener, self.indexfile, changelog2, linkmapper)
...
class unionmanifest(unionrevlog, manifest.manifestrevlog):
    def __init__(self, opener, opener2, linkmapper):
        ...
        unionrevlog.__init__(self, opener, self.indexfile, manifest2, linkmapper)
...
class unionfilelog(unionrevlog, filelog.filelog):
    def __init__(self, opener, path, opener2, linkmapper, repo):
        ...
        unionrevlog.__init__(self, opener, self.indexfile, filelog2, linkmapper)
        self._repo = repo
...
class unionrepository(localrepo.localrepository):
    def __init__(self, ui, path, path2):
        ...
        self._url = "union:%s+%s" % (util.expandpath(path), util.expandpath(path2))
    ...
    def _constructmanifest(self):
        return unionmanifest(self.svfs, self.repo2.svfs, self.unfiltered()._clrev)
