...
import YokedActorHeading from './YokedActorHeading';
...
function PullRequestTimelineBootstrap(): React.ReactElement {
  ...
  let version = 1;
  return (
    <Box display="flex" flexDirection="column" gridGap={3} padding={4} paddingTop={8}>
  ...
  return (
    ...
    >
      <Box display="flex" justifyContent="space-between">
        <Box display="flex" alignItems={'center'} paddingBottom={2} gridGap={1}>
          <YokedActorHeading actor={props.actor} />
          {/* <Text fontSize={12}>commented</Text> */}
        </Box>
  ...
  return (
    <Box>
      <Box
        ...
        paddingY={0}>
        {/* <HorizontalLine isPrefix={true} /> */}
        <Text color="neutral.emphasis">Version {version}</Text>
        {/* <HorizontalLine isPrefix={false} /> */}
      </Box>
    </Box>
  );
