...
import YokedPullRequestInlineCommentInput from './YokedPullRequestInlineCommentInput';
  ...
  return (
    <Box ref={ref} padding={2}>
      <Box display="flex" justifyContent="space-between">
        <YokedActorHeading actor={comment.author} />
        {pendingLabel}
      </Box>
...
function Reply(props: {commentID: ID; commitID: GitObjectID}): React.ReactElement {
  ...
  if (showReply) {
    return <YokedPullRequestInlineCommentInput {...props} onCancel={() => setShowReply(false)} />;
  }
