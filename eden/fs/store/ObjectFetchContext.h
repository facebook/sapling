 ...
 private:
  ...
  std::unordered_map<
      ...
      saplingStatsMap_ = {
          ...
          {{FetchedSource::Remote, ObjectType::TreeAuxData},
           &SaplingBackingStoreStats::fetchTreeAuxDataRemote},
          ...
          {{FetchedSource::Remote, ObjectType::BlobAuxData},
           &SaplingBackingStoreStats::fetchBlobAuxDataRemote},
