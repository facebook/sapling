 ...
 private:
  ...
  std::unordered_map<
      ...
      saplingStatsMap_ = {
          ...
          {{FetchedSource::Local, ObjectType::TreeMetadata},
           &SaplingBackingStoreStats::fetchTreeMetadataLocal},
          {{FetchedSource::Remote, ObjectType::TreeMetadata},
           &SaplingBackingStoreStats::fetchTreeMetadataRemote},
