...
pub fn bench_read_mfmd(test_dir: &TestDir, random_data: &RandomData) -> Result<Benchmark> {
...
pub fn bench_read_sfmd(test_dir: &TestDir, random_data: &RandomData) -> Result<Benchmark> {
