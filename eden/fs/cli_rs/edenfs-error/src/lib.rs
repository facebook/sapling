...
use thrift_thriftclients::thrift::errors::GetScmStatusBetweenRevisionsError;
...
use thrift_thriftclients::thrift::errors::PeekCurrentJournalPositionError;
...
impl_has_error_handling_strategy!(GetScmStatusBetweenRevisionsError);
...
impl_has_error_handling_strategy!(PeekCurrentJournalPositionError);
