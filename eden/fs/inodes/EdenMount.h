...
class EdenMount {
 public:
   ...
   * destroyed.
   *
   * If doTakeover is true, this function will return a populated
   * SerializedFileHandleMap instance generated by calling
   * FileHandleMap::serializeMap().
   *
   * If doTakeover is false, this function will return a default-constructed
   * SerializedFileHandleMap instance.
   */
  folly::Future<SerializedFileHandleMap> shutdown(bool doTakeover);
