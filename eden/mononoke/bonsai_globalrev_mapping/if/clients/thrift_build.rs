...
const CRATEMAP: &str = "\
eden/mononoke/bonsai_globalrev_mapping/if/bonsai_globalrev_mapping.thrift crate //eden/mononoke/bonsai_globalrev_mapping/if:bonsai_globalrev_mapping_thrift-rust
