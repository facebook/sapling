...
thrift/annotation/scope.thrift fb303_core->cpp->scope //thrift/annotation:scope-rust
thrift/annotation/thrift.thrift fb303_core->cpp->thrift //thrift/annotation:thrift-rust
";
#[rustfmt::skip]
fn main() {
