...
/// CrossRepoSyncPushrebase hook is responsible for updating the mapping versions of pushrebased commits for
...
///  2. Updating small-to-large mapping for commits that were forward-synced from small repo via pushrebase:
