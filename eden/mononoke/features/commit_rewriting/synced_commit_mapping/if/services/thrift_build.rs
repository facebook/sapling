...
const CRATEMAP: &str = "\
eden/mononoke/features/commit_rewriting/synced_commit_mapping/if/synced_commit_mapping.thrift crate //eden/mononoke/features/commit_rewriting/synced_commit_mapping/if:synced_commit_mapping_thrift-rust
...
fn main() {
    ...
    Config::from_env(GenContext::Services)
        ...
        .base_path("../../../../../../..")
        .types_crate("synced_commit_mapping_thrift__types")
        .clients_crate("synced_commit_mapping_thrift__clients")
        .run(["../synced_commit_mapping.thrift"])
