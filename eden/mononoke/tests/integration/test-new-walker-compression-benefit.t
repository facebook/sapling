...
compression-benefit, all compressible types
  ...
  * Run */s,*/s,2*,2*,1%,*s; Type:Raw,Compressed,%Saving AliasContentMapping:333,333,0% BonsaiHgMapping:281,281,0% Bookmark:0,0,0% Changeset:277,277,0% FileContent:12,12,0% FileContentMetadata:3*,3*,0% HgBonsaiMapping:0,0,0% HgChangeset:281,281,0% HgChangesetViaBonsai:0,0,0% HgFileEnvelope:189,189,0% HgFileNode:0,0,0% HgManifest:444,415,6%* (glob)
