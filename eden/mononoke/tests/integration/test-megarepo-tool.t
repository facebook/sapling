...
move things in fbsource
  ...
  * Setting bookmark BookmarkKey { bookmark: "fbsource_move" } to point to * (glob)
  * Setting bookmark BookmarkKey { bookmark: "fbsource_move" } finished (glob)
...
move things in ovrsource in a stack
  ...
  * changeset resolved as: * (glob)
  * Marked as public * (glob)
  * Setting bookmark BookmarkKey { bookmark: "ovrsource_move" } to point to * (glob)
  * Setting bookmark BookmarkKey { bookmark: "ovrsource_move" } finished (glob)
  * Generating an HG equivalent of * (glob)
...
merge things in both repos
  ...
  * Marked as public * (glob)
  * Setting bookmark BookmarkKey { bookmark: "master" } to point to * (glob)
  * Setting bookmark BookmarkKey { bookmark: "master" } finished (glob)
  * Generating an HG equivalent of * (glob)
  * Hg equivalent of *: HgChangesetId(HgNodeHash(Sha1(*))) (glob)
