...
# Test missing-for-commit flag (against partially imported repo history)
  ...
  using repo "repo" repoid RepositoryId(0)
  GitRepo:$TESTTMP/repo-git commit 1 of 2 - Oid:8ce3eae4 => Bid:032cd4dc (already exists)
...
# Also check that a readonly import works
  ...
  using repo "repo" repoid RepositoryId(0)
  GitRepo:$TESTTMP/repo-git commit 1 of 2 - Oid:8ce3eae4 => Bid:032cd4dc (already exists)
  GitRepo:$TESTTMP/repo-git commit 2 of 2 - Oid:e8615d6f => Bid:da93dc81 (already exists)
...
# at Mononoke end
  ...
  $ mononoke_newadmin bookmarks -R repo get tags/empty_tag
...
# This should return an emtpy metadata changeset since we don't store those for simple tags
  $ mononoke_newadmin bookmarks -R repo get tags/simple_tag
