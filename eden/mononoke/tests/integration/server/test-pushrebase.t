...
#require slow
  ...
  $ BLOB_TYPE="blob_files" default_setup_drawdag --scuba-log-file "$TESTTMP/log.json"
...
Push stack
  ...
  $ log -r "all()"
  @  4 [public;rev=5;6c33ca0cbd4d] remote/master_bookmark
  │
  o  3 [public;rev=4;663c2d9c201e]
  │
...
Push fast-forward
  ...
  $ log -r "all()"
  @  5 [public;rev=6;b9f277aaa224] remote/master_bookmark
  │
  o  4 [public;rev=5;6c33ca0cbd4d]
  │
  o  3 [public;rev=4;663c2d9c201e]
  │
  o  1 [public;rev=3;c39a1f67cdbc]
...
Push a merge commit with both parents not ancestors of destination bookmark
  ...
  $ hg merge -q -r 22cfc5c8c7f6 && hg ci -m "merge 6 and 7"
  $ log -r "all()"
  @    merge 6 and 7 [draft;rev=281474976710664;3216c28e1752]
  ├─╮
  │ o  7 [draft;rev=281474976710663;963a2e3bcf35]
  │ │
  o │  6 [draft;rev=281474976710662;22cfc5c8c7f6]
  ├─╯
  │ o  5 [public;rev=6;b9f277aaa224] remote/master_bookmark
  │ │
  │ o  4 [public;rev=5;6c33ca0cbd4d]
  │ │
  │ o  3 [public;rev=4;663c2d9c201e]
  ...
  $ hg up master_bookmark -q && hg hide -r "22cfc5c8c7f6+963a2e3bcf35+3216c28e1752" -q
  $ log -r "all()"
  @    merge 6 and 7 [public;rev=9;98f9e08333e0] remote/master_bookmark
  ├─╮
  │ o  7 [public;rev=8;5c369a3ce002]
  │ │
  o │  6 [public;rev=7;18e02fd69ab4]
  ├─╯
  o  5 [public;rev=6;b9f277aaa224]
  │
  o  4 [public;rev=5;6c33ca0cbd4d]
  │
  o  3 [public;rev=4;663c2d9c201e]
...
- Do some preparatory work
  ...
  $ hg merge -qr 'desc(10)' && hg ci -qm "merge 10 and 12"
...
Test creating a bookmark on a public commit
  $ hg push --rev 1065de83df59 --to master_bookmark_2 --create
  ...
  $ log -r "99a124548fb0::"
  @    merge 10 and 12 [public;rev=14;1065de83df59] remote/master_bookmark remote/master_bookmark_2
  ├─╮
  │ o  12 [public;rev=13;67c6d1914956]
  │ │
  o │  11 [public;rev=12;45d2d9680dec]
  │ │
  o │  10 [public;rev=11;715b5a513881]
  ├─╯
  o  9 [public;rev=10;99a124548fb0]
  │
  ~

Test a non-forward push
  $ hg up 45d2d9680dec -q
  $ log -r "99a124548fb0::"
  o    merge 10 and 12 [public;rev=14;1065de83df59] remote/master_bookmark remote/master_bookmark_2
  ├─╮
  │ o  12 [public;rev=13;67c6d1914956]
  │ │
  @ │  11 [public;rev=12;45d2d9680dec]
  │ │
  o │  10 [public;rev=11;715b5a513881]
  ├─╯
  o  9 [public;rev=10;99a124548fb0]
  ...
  $ log -r "99a124548fb0::"
  o    merge 10 and 12 [public;rev=14;1065de83df59] remote/master_bookmark
  ├─╮
  │ o  12 [public;rev=13;67c6d1914956]
  │ │
  @ │  11 [public;rev=12;45d2d9680dec] remote/master_bookmark_2
  │ │
  o │  10 [public;rev=11;715b5a513881]
  ├─╯
  o  9 [public;rev=10;99a124548fb0]
...
Test non-fast-forward force pushrebase
  $ hg up -qr 99a124548fb0
  $ echo Aeneas > was_a_lively_fellow && hg ci -qAm 26
  $ log -r "99a124548fb0::"
  @  26 [draft;rev=281474976710668;10b6d4d89240]
  │
  │ o  draft [public;rev=281474976710667;db727ac656f2] remote/newbook
  │ │
  │ │ o  merge 10 and 12 [public;rev=14;1065de83df59] remote/master_bookmark
  │ ╭─┤
  │ │ o  12 [public;rev=13;67c6d1914956]
...
Check that we can replace a file with a directory
  ...
  hello
  $ log -r 8294354c0a10
  @  replace a file with a dir [public;rev=281474976710671;8294354c0a10] remote/newbook
  │
  ~
