...
# Verify that pushrebase merge resolution cleanly merges non-overlapping edits.
#
# When two sides modify different regions of the same file (server edits the
# top, client edits the bottom), the 3-way merge produces a combined result
# and pushrebase succeeds instead of rejecting with a path conflict.
...
Pushrebase should succeed — merge resolution combines both edits
