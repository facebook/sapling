...
exactly one of `-T` or `--all-flags` are provided:
  ...
  Usage: admin derived-data derive <--commit-id <COMMIT_ID>|--bookmark <BOOKMARK>|--all-bookmarks|--bookmark-regex <BOOKMARK_REGEX>> <--derived-data-types <DERIVED_DATA_TYPES>|--all-types>
