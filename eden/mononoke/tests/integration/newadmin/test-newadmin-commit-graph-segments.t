...
returns nothing as there are no ancestors of C that are not also ancestors of I
  $ mononoke_admin commit-graph -R repo segments --heads $C --common $I --verify

returns a segment representing E, F and G and a segment representing D
  $ mononoke_admin commit-graph -R repo segments --heads $G --common $H --verify
...
returns 4 segments representing G-F, L-E, J-H, D
  $ mononoke_admin commit-graph -R repo segments --heads $J,$G,$L --common $C --verify
...
returns 3 segments representing G-E, C, D-A
  $ mononoke_admin commit-graph -R repo segments --heads $G --verify
