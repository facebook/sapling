...
Sync all bookmarks moves (the second move is a merge commit)
  ...
  log entries [1, 2] synced (3 commits uploaded, upload stats: uploaded digests: 6, already present digests: 0, uploaded bytes: 1.6 kiB, the largest uploaded blob: 914 B), took overall * sec, repo: repo (glob)
...
Demo a bug that 2 blobs are missing in CAS for the merge commit F
  $ with_stripped_logs mononoke_newadmin cas-store --repo-name repo upload --full --hg-id $F
  Upload completed. Upload stats: uploaded digests: 2, already present digests: 4, uploaded bytes: 60 B, the largest uploaded blob: 30 B
