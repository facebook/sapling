...
--verify the working copy
  ...
  * ### (glob)
  * ### Checking that all the paths from the repo meg_mon are properly rewritten to with_merge_mon (glob)
  * ### (glob)
  * ### (glob)
  * ### Checking that all the paths from the repo with_merge_mon are properly rewritten to meg_mon (glob)
  * ### (glob)
  * all is well! (glob)
