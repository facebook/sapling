...
get content_id for file B
  $ mononoke_admin fetch -R repo -B master_bookmark 2> /dev/null | grep BonsaiChangesetId
...
upload C as it wasn't imported
  ...
  $ mononoke_admin bookmarks -R repo set master_bookmark 2fd0d90fc6899dd5643e344ebad05bbd6014382de3341654a7630de99bb1f96f
...
Sync to backup repo
  ...
  $ REPOID=1 mononoke_admin fetch --repo-id=1 -B master_bookmark 2> /dev/null | grep BonsaiChangesetId
  BonsaiChangesetId: d0356578495b2a286e817587034d9fbda1eb317d619496ee03a211f34d9e06da
