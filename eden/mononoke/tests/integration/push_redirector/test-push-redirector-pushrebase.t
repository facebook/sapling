...
Normal pushrebase with one commit
  ...
  $ quiet sl push -r . --to master_bookmark
...
Bookmark-only pushrebase (Create a new bookmark, do not push commits)
  $ cd "$TESTTMP/small-hg-client"
  $ sl push -r master_bookmark^ --to master_bookmark_2 --create 2>&1 | grep 'creating remote bookmark'
...
Noop bookmark-only pushrebase
  ...
  6
  $ sl push -r master_bookmark^ --to master_bookmark_2 |& grep 'moving remote bookmark'
...
Delete a bookmark
  $ cd "$TESTTMP/small-hg-client"
  $ quiet_grep deleting -- sl push --delete master_bookmark_2
...
Pushrebase, which copies and removes files
  ...
  $ sl push --to master_bookmark 2>&1 | grep 'updated remote bookmark'
...
-- push to create a second bookmark
  ...
  $ sl push --to master_bookmark_2 --create -q
...
-- push to update a second bookmark
  ...
  $ sl push --to master_bookmark_2 2>&1 | grep 'updated remote bookmark'
