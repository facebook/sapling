...
# Partial clone the repo from Mononoke and ensure we get the same number of objects
  $ quiet git_client clone $MONONOKE_GIT_SERVICE_BASE_URL/$REPONAME.git --filter=object:type=blob --no-checkout
...
# Partial clone the repo from Mononoke and ensure we get the same number of objects
  $ quiet git_client clone --filter=blob:none --no-checkout $MONONOKE_GIT_SERVICE_BASE_URL/$REPONAME.git
...
# Partial clone the repo from Mononoke and ensure we get the same number of objects
  $ quiet git_client clone --filter=blob:limit=9m --no-checkout $MONONOKE_GIT_SERVICE_BASE_URL/$REPONAME.git
