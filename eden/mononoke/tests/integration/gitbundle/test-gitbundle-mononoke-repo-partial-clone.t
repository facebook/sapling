...
# Import the new commits into Mononoke
  ...
  GitRepo:$TESTTMP/repo-git 2 of 4 commit(s) already exist* (glob)
  GitRepo:$TESTTMP/repo-git commit 4 of 4 - Oid:2fffba32 => Bid:9a3b8a37* (glob)
  Hg: Sha1(*): HgManifestId(HgNodeHash(Sha1(*))) (glob)
  Hg: Sha1(*): HgManifestId(HgNodeHash(Sha1(*))) (glob)
  Hg: Sha1(*): HgManifestId(HgNodeHash(Sha1(*))) (glob)
  Hg: Sha1(*): HgManifestId(HgNodeHash(Sha1(*))) (glob)
  Ref: "refs/heads/master_bookmark": Some(ChangesetId(Blake2(9a3b8a37081bad8b5abdefbe01391b4960afcb329164cc03e3b52161912fd764)))
  Ref: "refs/tags/empty_tag": Some(ChangesetId(Blake2(da93dc81badd8d407db0f3219ec0ec78f1ef750ebfa95735bb483310371af80c)))
  ...
  Initialized repo: repo
  All repos initialized. It took: * seconds (glob)
  Bookmark: "heads/master_bookmark": ChangesetId(Blake2(9a3b8a37081bad8b5abdefbe01391b4960afcb329164cc03e3b52161912fd764)) (moved from ChangesetId(Blake2(da93dc81badd8d407db0f3219ec0ec78f1ef750ebfa95735bb483310371af80c)))
