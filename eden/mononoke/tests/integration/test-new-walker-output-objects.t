...
Output pretty debug to stdout
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai --include-output-node-type=Changeset 2>&1 | strip_glog
...
Output non-pretty debug to stdout
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai --include-output-node-type=Changeset --output-format=Debug 2>&1 | strip_glog
  Walking edge types [BookmarkToChangeset]
  Walking node types [Bookmark, Changeset]
