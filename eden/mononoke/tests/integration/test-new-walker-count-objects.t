...
count-objects, all types, shallow edges
  $ mononoke_new_walker -l loaded scrub -q -b master_bookmark -I shallow -i all 2>&1 | strip_glog
  Seen,Loaded: 48,48

count-objects, all types, deep edges
  $ mononoke_new_walker -l loaded scrub -q -b master_bookmark -I deep -i all 2>&1 | strip_glog
  Seen,Loaded: 83,83
...
count-objects, all types, all edges, difference in final count vs deep edges is PhaseMapping and one extra BonsaiHgMapping from the bookmark
  $ mononoke_new_walker -l loaded scrub -q -b master_bookmark -I all -i all 2>&1 | strip_glog
  Seen,Loaded: 86,86
...
count-objects, shallow, bonsai only.  No parents, expect just one of each node type. Also exclude FsnodeToFileContent to keep the test intact
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -X hg -x BonsaiHgMapping -X FsnodeToFileContent -i default -i derived_fsnodes 2>&1 | strip_glog
...
count-objects, hg only. total nodes is HGCOUNT plus 1 for the root bookmark step, plus 1 for mapping from bookmark to hg. plus 3 for filenode (same blob as envelope)
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I hg 2>&1 | strip_glog
...
count-objects, default shallow walk across bonsai and hg data, but exclude HgFileEnvelope so that we can test that we visit FileContent from fsnodes
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -x HgFileEnvelope -i default -i derived_fsnodes 2>&1 | strip_glog
...
count-objects, default shallow walk across bonsai and hg data, including mutable
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -I marker 2>&1 | strip_glog
...
count-objects, default shallow walk across bonsai and hg data, including mutable for all public heads
  $ mononoke_new_walker -L sizing scrub -q --walk-root PublishedBookmarks -I shallow -I marker 2>&1 | strip_glog
...
count-objects, shallow walk across bonsai and changeset_info
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_changeset_info 2>&1 | strip_glog
...
count-objects, deep walk across bonsai and changeset_info
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_changeset_info 2>&1 | strip_glog
...
count-objects, shallow walk across bonsai and unodes
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_unodes -i FileContent -X ChangesetToFileContent 2>&1 | strip_glog
...
count-objects, deep walk across bonsai and unodes
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_unodes -X ChangesetToBonsaiParent 2>&1 | strip_glog
...
count-objects, shallow walk across blame
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_unodes -i derived_blame -X ChangesetToFileContent -X UnodeFileToFileContent 2>&1 | strip_glog
...
count-objects, deep walk across blame
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_unodes -i derived_blame -X ChangesetToBonsaiParent -X UnodeFileToLinkedChangeset -X UnodeManifestToLinkedChangeset 2>&1 | strip_glog
...
count-objects, shallow walk across deleted files manifest
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_deleted_manifest -X ChangesetToFileContent 2>&1 | strip_glog
...
count-objects, deep walk across deleted files manifest
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_deleted_manifest 2>&1 | strip_glog
...
count-objects, shallow walk across skeleton manifest
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_skeleton_manifests -X ChangesetToFileContent 2>&1 | strip_glog
...
count-objects, deep walk across skeleton manifest
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_skeleton_manifests 2>&1 | strip_glog
...
count-objects, shallow walk across fastlog
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -i bonsai -i derived_unodes -i derived_fastlog -X ChangesetToFileContent -X UnodeFileToFileContent 2>&1 | strip_glog
...
count-objects, deep walk across fastlog
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -i bonsai -i derived_unodes -i derived_fastlog -X ChangesetToBonsaiParent -X UnodeFileToLinkedChangeset -X UnodeManifestToLinkedChangeset 2>&1 | strip_glog
...
count-objects, shallow walk across hg
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I shallow -I BookmarkToBonsaiHgMapping -i Bookmark -i hg 2>&1 | strip_glog
...
count-objects, deep walk across hg
  $ mononoke_new_walker -L sizing scrub -q -b master_bookmark -I deep -I BookmarkToBonsaiHgMapping -i Bookmark -i hg 2>&1 | strip_glog
