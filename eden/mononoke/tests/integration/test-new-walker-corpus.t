...
Base case, sample all in one go. Expeding WALKABLEBLOBCOUNT keys plus mappings and root.  Note that the total is 3086, but blobs are 2805. This is due to BonsaiHgMapping loading the hg changeset
  ...
  * Run */s,*/s,3113,36,0s; Type:Raw,Compressed AliasContentMapping:333,9 BonsaiHgMapping:281,3 Bookmark:0,0 Changeset:277,3 FileContent:12,3 FileContentMetadata:378,3 Fsnode:822,3 FsnodeMapping:96,3 HgBonsaiMapping:0,0 HgChangeset:281,3 HgChangesetViaBonsai:0,0 HgFileEnvelope:189,3 HgFileNode:0,0 HgManifest:444,3* (glob)
...
Repeat but using the sample-offset to slice.  Offset zero will tend to be larger as root paths sample as zero. 2000+475+611=3086
  ...
  slice 0
  Seen,Loaded: 46,46
  * Run */s,*/s,2009,17,*s; * (glob)
  slice 1
  Seen,Loaded: 46,46
  * Run */s,*/s,484,9,*s; * (glob)
  slice 2
  Seen,Loaded: 46,46
  * Run */s,*/s,620,10,*s; * (glob)
...
See the breakdown
  ...
  slice/0/FileContentMetadata 126
  slice/0/Fsnode 822
  ...
  slice/1/FileContentMetadata 126
  ...
  slice/2/FileContentMetadata 126
...
Check path regex can pick out just one path
  ...
  * Run */s,*/s,304,6,0s; Type:Raw,Compressed AliasContentMapping:111,3 BonsaiHgMapping:0,0 Bookmark:0,0 Changeset:0,0 FileContent:4,1 FileContentMetadata:126,1 Fsnode:0,0 FsnodeMapping:0,0 HgBonsaiMapping:0,0 HgChangeset:0,0 HgChangesetViaBonsai:0,0 HgFileEnvelope:63,1 HgFileNode:0,0 HgManifest:0,0* (glob)
