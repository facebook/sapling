...
Run the heal, with write errors injected, simulating store still bad
  ...
  1 Fetched 33 distinct put operations
  1 Found 33 blobs to be healed... Doing it with weight limit 10000000000, max concurrency: 100
  ...
  1 Couldn't heal blob repo0000.alias.seeded_blake3.5667f2421ac250c4bb9af657b5ead3cdbd940bfbc350b2bfee47454643832b48 in these blobstores: {BlobstoreId(0)}
  1 Couldn't heal blob repo0000.alias.seeded_blake3.5ad3ba58a716e5fc04296ac9af7a1420f726b401fdf16d270beb5b6b30bc0cda in these blobstores: {BlobstoreId(0)}
  1 Couldn't heal blob repo0000.alias.seeded_blake3.6fb4c384e79ac0771a483fcf3c46fb4ea8609f79608e8bcbf710f9887a3b9cf6 in these blobstores: {BlobstoreId(0)}
  ...
  1 For 33 processed entries and 33 blobstore keys: healthy blobs 0, healed blobs 0, failed to heal 33, missing blobs 0
  1 Requeueing 33 queue entries for another healing attempt
  1 Deleting 33 actioned queue entries
...
Healer run again now store recovered
  ...
  1 Fetched 33 distinct put operations
  1 Found 33 blobs to be healed... Doing it with weight limit 10000000000, max concurrency: 100
  1 For 33 processed entries and 33 blobstore keys: healthy blobs 0, healed blobs 33, failed to heal 0, missing blobs 0
  1 Deleting 33 actioned queue entries
  1 Iteration rows processed: * rows, *s; total: * rows, *s (glob)
  1 The last batch was not full size, waiting...
