...
Do a push, while bundle preservation is enabled
  ...
  pushing rev dc31470c8386 to destination mononoke://$LOCALIP:$LOCAL_PORT/repo bookmark master_bookmark
...
Do a pushrebase, while preservation is enabled
  ...
  pushing rev 1c1c6e358bc0 to destination mononoke://$LOCALIP:$LOCAL_PORT/repo bookmark master_bookmark
  searching for changes
  adding changesets
  adding manifests
  adding file changes
