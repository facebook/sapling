...
Sync all bookmarks moves
  ...
  Entry BookmarkUpdateLogEntry { id: 2, repo_id: RepositoryId(0), bookmark_name: BookmarkKey { name: BookmarkName { bookmark: "master_bookmark" }, category: Branch }, from_changeset_id: Some(ChangesetId(Blake2(53b034a90fe3002a707a7da9cdf6eac3dea460ad72f7c6969dfb88fd0e69f856))), to_changeset_id: Some(ChangesetId(Blake2(5b1c7130dde8e54b4285b9153d8e56d69fbf4ae685eaf9e9766cc409861995f8))), reason: Push, timestamp: Timestamp(*) } (glob)
