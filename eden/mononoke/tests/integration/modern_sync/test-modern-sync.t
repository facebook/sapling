...
Sync all bookmarks moves
  ...
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(dba92ad67dc1f3732ab73a5f51b77129275a1724)))
  Changed manifest
  Changed manifest
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(b31c6c30a54b89020d5ac28a67917349512d75eb)))
  ...
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(4eec8cfdabce9565739489483b6ad93ef7657ea9)))
  Changed manifest
  Changed manifest
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(aae2838d921bcc14ccbb9212f4175f300fd9f2f8)))
  ...
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(a2e456504a5e61f763f1a0b36a6c247c7541b2b3)))
  Changed manifest
  Changed manifest
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(9bad1c227e9133a5bbae1652c889406d35e6dac1)))
  ...
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(35e7525ce3a48913275d7061dd9a867ffef1e34d)))
  Changed manifest
  Changed manifest
  Many new or changed manifests
  Found filenode id HgFileNodeId(HgNodeHash(Sha1(778675f9ec8d35ff2fce23a34f68edd15d783853)))
