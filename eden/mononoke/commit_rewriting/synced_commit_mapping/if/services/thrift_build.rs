...
const CRATEMAP: &str = "\
eden/mononoke/commit_rewriting/synced_commit_mapping/if/synced_commit_mapping.thrift crate //eden/mononoke/commit_rewriting/synced_commit_mapping/if:synced_commit_mapping_thrift-rust
