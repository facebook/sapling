...
eden/mononoke/repo_attributes/bonsai_hg_mapping/if/bonsai_hg_mapping.thrift crate //eden/mononoke/repo_attributes/bonsai_hg_mapping/if:bonsai_hg_mapping_entry_thrift-rust
...
fn main() {
    ...
    Config::from_env(GenContext::Types)
        ...
        .base_path("../../../../..")
        .types_crate("bonsai_hg_mapping_entry_thrift__types")
        .clients_crate("bonsai_hg_mapping_entry_thrift__clients")
        .run(["bonsai_hg_mapping.thrift"])
