...
eden/mononoke/repo_attributes/bonsai_globalrev_mapping/if/bonsai_globalrev_mapping.thrift crate //eden/mononoke/repo_attributes/bonsai_globalrev_mapping/if:bonsai_globalrev_mapping_thrift-rust
...
fn main() {
    ...
    Config::from_env(GenContext::Types)
        ...
        .base_path("../../../../..")
        .types_crate("bonsai_globalrev_mapping_thrift__types")
        .clients_crate("bonsai_globalrev_mapping_thrift__clients")
        .run(["bonsai_globalrev_mapping.thrift"])
