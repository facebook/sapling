...
fn create_entries() -> HashMap<usize, HgMutationEntry> {
    ...
    hashmap! {
        ...
        8 => HgMutationEntry::new(
            make_hg_cs_id(8),
            smallvec![make_hg_cs_id(7), make_hg_cs_id(9)],
            vec![],
            String::from("fold"),
            String::from("testuser"),
            EPOCH_ZERO.clone(),
        ...
        14 => HgMutationEntry::new(
            make_hg_cs_id(14),
            smallvec![make_hg_cs_id(11), make_hg_cs_id(13)],
            vec![],
            String::from("fold"),
            String::from("testuser"),
            EPOCH_ZERO.clone(),
