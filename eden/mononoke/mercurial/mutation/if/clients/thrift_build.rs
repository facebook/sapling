...
thrift/annotation/rust.thrift mercurial_thrift->mononoke_types_serialization->rust //thrift/annotation:rust-rust
thrift/annotation/scope.thrift mercurial_thrift->mononoke_types_serialization->rust->scope //thrift/annotation:scope-rust
";
#[rustfmt::skip]
fn main() {
