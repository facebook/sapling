...
impl DerivableType {
    pub fn from_name(s: &str) -> Result<Self> {
        ...
        Ok(match s {
            ...
            "fastlog_v2" => DerivableType::FastlogV2,
            ...
            "hg_augmented_manifests_v2" => DerivableType::HgAugmentedManifestsV2,
    ...
    pub const fn name(&self) -> &'static str {
        ...
        match self {
            ...
            DerivableType::FastlogV2 => "fastlog_v2",
            ...
            DerivableType::HgAugmentedManifestsV2 => "hg_augmented_manifests_v2",
    ...
    pub fn from_thrift(other: thrift::DerivedDataType) -> Result<Self> {
        Ok(match other {
            ...
            thrift::DerivedDataType::FASTLOG_V2 => Self::FastlogV2,
            ...
            thrift::DerivedDataType::HG_AUGMENTED_MANIFEST_V2 => Self::HgAugmentedManifestsV2,
    ...
    pub fn into_thrift(&self) -> thrift::DerivedDataType {
        match self {
            ...
            Self::FastlogV2 => thrift::DerivedDataType::FASTLOG_V2,
            ...
            Self::HgAugmentedManifestsV2 => thrift::DerivedDataType::HG_AUGMENTED_MANIFEST_V2,
