...
pub async fn run(app: MononokeApp, args: CommandArgs) -> Result<()> {
    ...
    match args.subcommand {
        GitContentRefSubcommand::Create(create_args) => create::create(&repo, create_args).await?,
        GitContentRefSubcommand::Update(update_args) => update::update(&repo, update_args).await?,
        GitContentRefSubcommand::Get(get_args) => get::get(&repo, get_args).await?,
        GitContentRefSubcommand::Delete(delete_args) => delete::delete(&repo, delete_args).await?,
    }
    Ok(())
}
