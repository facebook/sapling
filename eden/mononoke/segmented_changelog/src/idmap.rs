...
mod tests {
    ...
    #[fbinit::compat_test]
    async fn test_build_idmap_linear(fb: FacebookInit) -> Result<()> {
    ...
    #[fbinit::compat_test]
    async fn test_build_idmap_merge_even(fb: FacebookInit) -> Result<()> {
        let ctx = CoreContext::test_mock(fb);
    ...
    #[fbinit::compat_test]
    async fn test_build_idmap_merge_uneven(fb: FacebookInit) -> Result<()> {
        let ctx = CoreContext::test_mock(fb);
