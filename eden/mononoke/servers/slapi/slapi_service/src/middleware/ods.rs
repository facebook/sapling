...
define_stats! {
    ...
    check_manifest_permission_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 95; P 99),
    check_path_permission_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 95; P 99),
    ...
    ephemeral_extend_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 95; P 99),
    ...
    files2_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 90; P 95; P 99),
    ...
    list_bookmark_patterns_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 95; P 99),
    ...
    trees_duration_ms: histogram(100, 0, 5000, Average, Sum, Count; P 50; P 75; P 90; P 95; P 99),
