...
pub const MUTABLE_COUNTERS: &'static str = "mutable-counters";
pub const MUTABLE_COUNTERS_NAME: &'static str = "name";
pub const MUTABLE_COUNTERS_VALUE: &'static str = "value";
pub const MUTABLE_COUNTERS_LIST: &'static str = "list";
pub const MUTABLE_COUNTERS_GET: &'static str = "get";
pub const MUTABLE_COUNTERS_SET: &'static str = "set";
