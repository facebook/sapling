...
async fn test_simple(fb: FacebookInit) -> Result<(), Error> {
    ...
    let dst_path = Some(NonRootMPath::new("dstpath")?);
    let src_path = Some(NonRootMPath::new("srcpath")?);
...
async fn test_insert_multiple(fb: FacebookInit) -> Result<(), Error> {
    ...
    let first_dst_path = Some(NonRootMPath::new("first_dstpath")?);
    let first_src_path = Some(NonRootMPath::new("second_srcpath")?);
    ...
    let second_dst_path = Some(NonRootMPath::new("second_dstpath")?);
    let second_src_path = Some(NonRootMPath::new("second_srcpath")?);
...
async fn test_overwrite(fb: FacebookInit) -> Result<(), Error> {
    ...
    let dst_path = Some(NonRootMPath::new("first_dstpath")?);
    let first_src_path = Some(NonRootMPath::new("first_srcpath")?);
    let first_entry = MutableRenameEntry::new(
        TWOS_CSID,
        dst_path.clone(),
        ONES_CSID,
