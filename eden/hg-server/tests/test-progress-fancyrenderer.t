...
test unicode topic
  ...
  [progress.fancy.bar.normal progress.fancy.topic| あいうえ: ][progress.fancy.bar.normal progress.fancy.item|あい][progress.fancy.bar.background progress.fancy.item|う                                 ][progress.fancy.bar.background progress.fancy.count|  1/4 04s ]\r (no-eol) (esc)
  \r (no-eol) (esc)
...
test line trimming when progress topic contains multi-byte characters
  ...
  \r (no-eol) (esc)
  \x1b[J[progress.fancy.bar.normal progress.fancy.topic| あ][progress.fancy.bar.background progress.fancy.topic|いうえ: ][progress.fancy.bar.background progress.fancy.count| ]\r (no-eol) (esc)
  \r (no-eol) (esc)
  \x1b[J[progress.fancy.bar.normal progress.fancy.topic| あ][progress.fancy.bar.background progress.fancy.topic|いうえ: ][progress.fancy.bar.background progress.fancy.count| ]\r (no-eol) (esc)
  \r (no-eol) (esc)
