...
coreconfigitem("edenfs", "automigrate", default=True)
...
coreconfigitem("experimental", "graph.renderer", default="legacy")
...
coreconfigitem("experimental", "rust-commits:addrevision", default=True)
coreconfigitem("experimental", "rust-commits:all", default=True)
...
coreconfigitem("experimental", "rust-commits:disableindex", default=True)
...
coreconfigitem("experimental", "rust-commits:nodemap", default=True)
coreconfigitem("experimental", "rust-commits:nodesbetween", default=True)
coreconfigitem("experimental", "rust-commits:parents", default=True)
coreconfigitem("experimental", "rust-commits:partialmatch", default=True)
...
coreconfigitem("experimental", "template-new-builtin", default=util.istest())
