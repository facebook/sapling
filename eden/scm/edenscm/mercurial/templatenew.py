...
builtinmapfiles = {
    "bisect": (
        {
            "changeset": "{cset}{lbisect}{bookmarks}{parents}{user}{ldate}{summary}\\n",
            ...
            "changeset_verbose": "{cset}{lbisect}{bookmarks}{parents}{user}{ldate}{lfiles}{lfile_copies_switch}{description}\\n",
            "lphase": '{label("log.phase",\n"phase:       {phase}")}\\n',
            "changeset_debug": "{fullcset}{lbisect}{bookmarks}{lphase}{parents}{manifest}{user}{ldate}{lfile_mods}{lfile_adds}{lfile_dels}{lfile_copies_switch}{extras}{description}\\n",
    ...
    "compact": (
        {
            "changeset": "{bookmarks}{parents}   {lnode}   {ldate}   {luser}\\n  {ldescfirst}\\n\\n",
            ...
            "changeset_verbose": "{parents}   {lnode}   {ldate}   {lauthor}\\n  {ldesc}\\n\\n",
    ...
    "default": (
        {
            "changeset": "{cset}{bookmarks}{parents}{user}{ldate}{summary}\\n",
            "ldate": '{label("log.date",\n"date:        {date|date}")}\\n',
            "lfiles": '{if(files,\nlabel("ui.note log.files",\n"files:       {files}\\n"))}',
            "lfile_adds": '{if(file_adds,\nlabel("ui.debug log.files",\n"files+:      {file_adds}\\n"))}',
            "manifest": '{label("ui.debug log.manifest",\n"manifest:    {node}")}\\n',
            ...
            "lnode": '{label("log.node",\n"{node|short}")}\\n',
            "summary": "{if(desc|strip, \"{label('log.summary',\n'summary:     {desc|firstline}')}\\n\")}",
            "changeset_verbose": "{cset}{bookmarks}{parents}{user}{ldate}{lfiles}{lfile_copies_switch}{description}\\n",
            "lphase": '{label("log.phase",\n"phase:       {phase}")}\\n',
            "changeset_debug": "{fullcset}{bookmarks}{lphase}{parents}{manifest}{user}{ldate}{lfile_mods}{lfile_adds}{lfile_dels}{lfile_copies_switch}{extras}{description}\\n",
            "lfile_mods": '{if(file_mods,\nlabel("ui.debug log.files",\n"files:       {file_mods}\\n"))}',
        },
        {},
        [
    ...
    "phases": (
        {
            "changeset": "{cset}{bookmarks}{lphase}{parents}{user}{ldate}{summary}\\n",
            "ldate": '{label("log.date",\n"date:        {date|date}")}\\n',
            "lfiles": '{if(files,\nlabel("ui.note log.files",\n"files:       {files}\\n"))}',
            "lfile_adds": '{if(file_adds,\nlabel("ui.debug log.files",\n"files+:      {file_adds}\\n"))}',
            "manifest": '{label("ui.debug log.manifest",\n"manifest:    {node}")}\\n',
            ...
            "lnode": '{label("log.node",\n"{node|short}")}\\n',
            "summary": "{if(desc|strip, \"{label('log.summary',\n'summary:     {desc|firstline}')}\\n\")}",
            "changeset_verbose": "{cset}{bookmarks}{lphase}{parents}{user}{ldate}{lfiles}{lfile_copies_switch}{description}\\n",
            "lphase": '{label("log.phase",\n"phase:       {phase}")}\\n',
            "changeset_debug": "{fullcset}{bookmarks}{lphase}{parents}{manifest}{user}{ldate}{lfile_mods}{lfile_adds}{lfile_dels}{lfile_copies_switch}{extras}{description}\\n",
            "lfile_mods": '{if(file_mods,\nlabel("ui.debug log.files",\n"files:       {file_mods}\\n"))}',
        },
    ...
    "status": (
        {
            "changeset": "{cset}{bookmarks}{parents}{user}{ldate}{summary}{lfiles}\\n",
            "ldate": '{label("log.date",\n"date:        {date|date}")}\\n',
            ...
            "lnode": '{label("log.node",\n"{node|short}")}\\n',
            "summary": "{if(desc|strip, \"{label('log.summary',\n'summary:     {desc|firstline}')}\\n\")}",
            "changeset_verbose": "{cset}{bookmarks}{parents}{user}{ldate}{description}{lfiles}\\n",
            "lphase": '{label("log.phase",\n"phase:       {phase}")}\\n',
            "changeset_debug": "{fullcset}{bookmarks}{lphase}{parents}{manifest}{user}{ldate}{extras}{description}{lfiles}\\n",
    ...
    "xml": (
        {
            "changeset": '<logentry node="{node}">\\n{bookmarks}{parents}<author email="{author|email|xmlescape}">{author|person|xmlescape}</author>\\n<date>{date|rfc3339date}</date>\\n<msg xml:space="preserve">{desc|xmlescape}</msg>\\n</logentry>\\n',
