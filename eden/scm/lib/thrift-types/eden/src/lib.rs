...
pub mod types {
    ...
    pub struct Glob {
        ...
        #[serde(default)]
        pub dtypes: Vec<crate::types::OsDtype>,
    }
    ...
    impl<'a> From<&'a Dtype> for i32 {
        #[inline]
        fn from(x: &'a Dtype) -> i32 {
            x.0
        }
    }
    ...
    impl std::str::FromStr for Dtype {
        ...
        fn from_str(string: &str) -> std::result::Result<Self, Self::Err> {
            match string {
                ...
                "CHAR" => Ok(Dtype::CHAR),
                "DIR" => Ok(Dtype::DIR),
                "BLOCK" => Ok(Dtype::BLOCK),
                "REGULAR" => Ok(Dtype::REGULAR),
                "LINK" => Ok(Dtype::LINK),
                "SOCKET" => Ok(Dtype::SOCKET),
                "WHITEOUT" => Ok(Dtype::WHITEOUT),
                _ => anyhow::bail!("Unable to parse {} as Dtype", string),
            }
        }
    }

    impl GetTType for Dtype {
        const TTYPE: TType = TType::I32;
    }

    impl<P: ProtocolWriter> Serialize<P> for Dtype {
        #[inline]
        fn write(&self, p: &mut P) {
            p.write_i32(self.into())
        }
    ...
    impl<P: ProtocolReader> Deserialize<P> for Dtype {
        #[inline]
        fn read(p: &mut P) -> anyhow::Result<Self> {
            Ok(Dtype::from(p.read_i32()?))
        }
    }
    ...
    impl<P: ProtocolWriter> Serialize<P> for self::DaemonInfo {
        fn write(&self, p: &mut P) {
            ...
            if let Some(some) = &self.uptime {
                p.write_field_begin("uptime", TType::Float, 4);
                Serialize::write(some, p);
                p.write_field_end();
            }
            p.write_field_stop();
        ...
        fn read(p: &mut P) -> anyhow::Result<Self> {
            ...
            loop {
                ...
                match (fty, fid as i32) {
                    ...
                    (TType::Float, 4) => field_uptime = Some(Deserialize::read(p)?),
                    (fty, _) => p.skip(fty)?,
                }
                p.read_field_end()?;
            }
    ...
    impl Default for self::EntryInformation {
        fn default() -> Self {
            Self {
    ...
    impl GetTType for self::EntryInformation {
        const TTYPE: TType = TType::Struct;
    }

    impl<P: ProtocolWriter> Serialize<P> for self::EntryInformation {
        fn write(&self, p: &mut P) {
            p.write_struct_begin("EntryInformation");
            p.write_field_begin("dtype", TType::I32, 1);
            Serialize::write(&self.dtype, p);
            p.write_field_end();
            p.write_field_stop();
            p.write_struct_end();
        }
    ...
    impl<P: ProtocolReader> Deserialize<P> for self::EntryInformation {
        fn read(p: &mut P) -> anyhow::Result<Self> {
            let mut field_dtype = None;
            let _ = p.read_struct_begin(|_| ())?;
            loop {
                let (_, fty, fid) = p.read_field_begin(|_| ())?;
                match (fty, fid as i32) {
                    (TType::Stop, _) => break,
                    (TType::I32, 1) => field_dtype = Some(Deserialize::read(p)?),
                    (fty, _) => p.skip(fty)?,
                }
                p.read_field_end()?;
            }
    ...
    impl Default for EntryInformationOrError {
        fn default() -> Self {
            Self::UnknownField(-1)
        }
    }

    impl GetTType for EntryInformationOrError {
        const TTYPE: TType = TType::Struct;
    }

    impl<P: ProtocolWriter> Serialize<P> for EntryInformationOrError {
        fn write(&self, p: &mut P) {
    ...
    impl<P: ProtocolReader> Deserialize<P> for EntryInformationOrError {
        fn read(p: &mut P) -> anyhow::Result<Self> {
            let _ = p.read_struct_begin(|_| ())?;
            let mut once = false;
            let mut alt = None;
            loop {
                ...
                match (fty, fid as i32, once) {
                    ...
                    (TType::Struct, 1, false) => {
                        once = true;
                        alt = Some(EntryInformationOrError::info(Deserialize::read(p)?));
                    }
                    (TType::Struct, 2, false) => {
                        once = true;
                        alt = Some(EntryInformationOrError::error(Deserialize::read(p)?));
                    }
                    (fty, _, false) => p.skip(fty)?,
                    (badty, badid, true) => return Err(From::from(::fbthrift::ApplicationException::new(
                        ::fbthrift::ApplicationExceptionErrorCode::ProtocolError,
...
pub mod services {
    pub mod eden_service {
        ...
        pub enum GetEntryInformationExn {
            Success(Vec<crate::types::EntryInformationOrError>),
            ex(crate::types::EdenError),
            ApplicationException(::fbthrift::types::ApplicationException),
        }

        impl From<crate::types::EdenError> for GetEntryInformationExn {
            fn from(exn: crate::types::EdenError) -> Self {
                GetEntryInformationExn::ex(exn)
            }
        }

        impl From<ApplicationException> for GetEntryInformationExn {
            fn from(exn: ApplicationException) -> Self {
        ...
        impl<P: ProtocolWriter> Serialize<P> for GetEntryInformationExn {
            fn write(&self, p: &mut P) {
        ...
        impl<P: ProtocolReader> Deserialize<P> for GetEntryInformationExn {
            fn read(p: &mut P) -> anyhow::Result<Self> {
                let _ = p.read_struct_begin(|_| ())?;
                let mut once = false;
                let mut alt = None;
                loop {
                    ...
                    match ((fty, fid as i32), once) {
                        ...
                        ((TType::List, 0i32), false) => {
                            once = true;
                            alt = Some(GetEntryInformationExn::Success(Deserialize::read(p)?));
                        }
                        ((TType::Struct, 1), false) => {
                            once = true;
                            alt = Some(GetEntryInformationExn::ex(Deserialize::read(p)?));
                        }
                        ((ty, _id), false) => p.skip(ty)?,
                        ((badty, badid), true) => return Err(From::from(
                            ApplicationException::new(
...
pub mod client {
    ...
    pub trait EdenService: fb303_core::client::BaseService + Send {
        ...
        fn getEntryInformation(
            ...
            arg_mountPoint: &crate::types::PathString,
            arg_paths: &[crate::types::PathString],
        ) -> std::pin::Pin<Box<dyn std::future::Future<Output = std::result::Result<Vec<crate::types::EntryInformationOrError>, crate::errors::eden_service::GetEntryInformationError>> + Send + 'static>>;
    ...
    {        fn listMounts(
        ...
        fn getEntryInformation(
            ...
            self.transport()
                ...
                .and_then(|reply| futures::future::ready({
                    let de = P::deserializer(reply);
                    move |mut p: P::Deserializer| -> std::result::Result<Vec<crate::types::EntryInformationOrError>, crate::errors::eden_service::GetEntryInformationError> {
                        let p = &mut p;
                        let (_, message_type, _) = p.read_message_begin(|_| ())?;
                        let result = match message_type {
                            MessageType::Reply => {
                                let exn = crate::services::eden_service::GetEntryInformationExn::read(p)?;
                                match exn {
                                    crate::services::eden_service::GetEntryInformationExn::Success(x) => Ok(x),
                                    crate::services::eden_service::GetEntryInformationExn::ex(err) => {
                                        Err(crate::errors::eden_service::GetEntryInformationError::ex(err))
                                    }
                                    crate::services::eden_service::GetEntryInformationExn::ApplicationException(ae) => {
                                        Err(crate::errors::eden_service::GetEntryInformationError::ApplicationException(ae))
                                    }
                                }
                            }
                            MessageType::Exception => {
                            ...
                            MessageType::Call | MessageType::Oneway | MessageType::InvalidMessageType => {
                                let err = anyhow::anyhow!("Unexpected message type {:?}", message_type);
                                Err(crate::errors::eden_service::GetEntryInformationError::ThriftError(err))
                            }
                        };
                        p.read_message_end()?;
                        result
...
pub mod server {
    ...
    pub trait EdenService: Send + Sync + 'static {
        ...
        async fn getEntryInformation(
            ...
            _mountPoint: crate::types::PathString,
            _paths: Vec<crate::types::PathString>,
        ) -> Result<Vec<crate::types::EntryInformationOrError>, crate::services::eden_service::GetEntryInformationExn> {
            Err(crate::services::eden_service::GetEntryInformationExn::ApplicationException(
                ApplicationException::unimplemented_method(
                    "EdenService",
                    "getEntryInformation",
                ),
        ...
        R: Sync,
    {
        ...
        async fn handle_getEntryInformation<'a>(
            ...
            let res = match res {
                ...
                Err(crate::services::eden_service::GetEntryInformationExn::ApplicationException(aexn)) => {
                    return Err(aexn.into())
                }
                Err(crate::services::eden_service::GetEntryInformationExn::Success(_)) => {
                    panic!(
                        "{} attempted to return success via error",
                        "getEntryInformation",
                    )
        ...
        R: Send + Sync + 'static,
    {
        ...
        fn method_idx(&self, name: &[u8]) -> Result<usize, ApplicationException> {
            match name {
                ...
                b"getEntryInformation" => Ok(15usize),
                b"getFileInformation" => Ok(16usize),
                b"glob" => Ok(17usize),
                b"globFiles" => Ok(18usize),
                b"chown" => Ok(19usize),
                b"getScmStatusV2" => Ok(20usize),
                b"getScmStatus" => Ok(21usize),
                b"getScmStatusBetweenRevisions" => Ok(22usize),
                b"getManifestEntry" => Ok(23usize),
                b"getDaemonInfo" => Ok(24usize),
                b"getPid" => Ok(25usize),
                b"initiateShutdown" => Ok(26usize),
                b"getConfig" => Ok(27usize),
                b"reloadConfig" => Ok(28usize),
                b"debugGetScmTree" => Ok(29usize),
                b"debugGetScmBlob" => Ok(30usize),
                b"debugGetScmBlobMetadata" => Ok(31usize),
                b"debugInodeStatus" => Ok(32usize),
                b"debugOutstandingFuseCalls" => Ok(33usize),
                b"debugGetInodePath" => Ok(34usize),
        ...
        async fn handle_method(
            ...
            match idx {
                ...
                15usize => self.handle_getEntryInformation(p, r, seqid).await,
                16usize => self.handle_getFileInformation(p, r, seqid).await,
                17usize => self.handle_glob(p, r, seqid).await,
                18usize => self.handle_globFiles(p, r, seqid).await,
                19usize => self.handle_chown(p, r, seqid).await,
                20usize => self.handle_getScmStatusV2(p, r, seqid).await,
                21usize => self.handle_getScmStatus(p, r, seqid).await,
                22usize => self.handle_getScmStatusBetweenRevisions(p, r, seqid).await,
                23usize => self.handle_getManifestEntry(p, r, seqid).await,
                24usize => self.handle_getDaemonInfo(p, r, seqid).await,
                25usize => self.handle_getPid(p, r, seqid).await,
                26usize => self.handle_initiateShutdown(p, r, seqid).await,
                27usize => self.handle_getConfig(p, r, seqid).await,
                28usize => self.handle_reloadConfig(p, r, seqid).await,
                29usize => self.handle_debugGetScmTree(p, r, seqid).await,
                30usize => self.handle_debugGetScmBlob(p, r, seqid).await,
                31usize => self.handle_debugGetScmBlobMetadata(p, r, seqid).await,
                32usize => self.handle_debugInodeStatus(p, r, seqid).await,
                33usize => self.handle_debugOutstandingFuseCalls(p, r, seqid).await,
                34usize => self.handle_debugGetInodePath(p, r, seqid).await,
...
pub mod mock {
    ...
    mod eden_service {
        ...
        pub struct getEntryInformation<'mock> {
            pub(super) closure: Mutex<Box<
                dyn FnMut(crate::types::PathString, Vec<crate::types::PathString>) -> Result<
                    Vec<crate::types::EntryInformationOrError>,
        ...
        impl<'mock> getEntryInformation<'mock> {
            ...
            pub fn ret(&self, value: Vec<crate::types::EntryInformationOrError>) {
                self.mock(move |_: crate::types::PathString, _: Vec<crate::types::PathString>| value.clone());
            }

            pub fn mock(&self, mut mock: impl FnMut(crate::types::PathString, Vec<crate::types::PathString>) -> Vec<crate::types::EntryInformationOrError> + Send + Sync + 'mock) {
                let mut closure = self.closure.lock().unwrap();
                *closure = Box::new(move |mountPoint, paths| Ok(mock(mountPoint, paths)));
            }
            ...
            pub fn throw<E>(&self, exception: E)
            where
                E: Into<crate::errors::eden_service::GetEntryInformationError>,
                E: Clone + Send + Sync + 'mock,
            {
                let mut closure = self.closure.lock().unwrap();
                *closure = Box::new(move |_: crate::types::PathString, _: Vec<crate::types::PathString>| Err(exception.clone().into()));
...
pub mod errors {
    pub mod eden_service {
        ...
        impl From<crate::types::EdenError> for GetEntryInformationError {
            fn from(e: crate::types::EdenError) -> Self {
                GetEntryInformationError::ex(e)
            }
        }

        impl From<::anyhow::Error> for GetEntryInformationError {
            fn from(err: ::anyhow::Error) -> Self {
                GetEntryInformationError::ThriftError(err)
            }
        }

        impl From<::fbthrift::ApplicationException> for GetEntryInformationError {
            fn from(ae: ::fbthrift::ApplicationException) -> Self {
