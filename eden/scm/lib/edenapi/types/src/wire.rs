...
/// Convert from an SaplingRemoteAPI API type to Wire type
...
/// Convert from an SaplingRemoteAPI Wire type to API type
...
pub mod local_tests {
    ...
    fn test_wire_json() {
        assert_eq!(
            ...
            [
                13424233448984516963,
                4896773572172581209,
                13380574630872175476,
                15686869937331483008,
                5787020349580062193,
                6294060359445534470,
                13603385362128272242,
            ]
        );
    }
}
