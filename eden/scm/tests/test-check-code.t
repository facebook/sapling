...
(The writing "no-che?k-code" is for not skipping this file when checking.)
  ...
  $ testrepohg files . | egrep -v "^(edenscm/ext/extlib/pywatchman|lib/cdatapack|lib/third-party|edenscm/mercurial/thirdparty|fb|newdoc|tests|edenscm/mercurial/templates/static|i18n|slides|.*\\.(bin|bindag|hg|pdf|jpg)$)" \
