...
test line trimming when progress topic contains multi-byte characters
  ...
  \x1b[K[progress.fancy.bar.normal progress.fancy.topic| あ][progress.fancy.bar.background progress.fancy.topic|いうえ: ][progress.fancy.bar.background progress.fancy.count| ]\r (no-eol) (esc)
  \x1b[K[progress.fancy.bar.normal progress.fancy.topic| あ][progress.fancy.bar.background progress.fancy.topic|いうえ: ][progress.fancy.bar.background progress.fancy.count| ]\r (no-eol) (esc)
