...
Set up clients repository
  ...
  $ sl clone ssh://user@dummy/server otherclient -q
...
push doesn't directly go to the server
  ...
  $ sl debugstrip d446b1b2be434509eb0ed51c1da3056d1bc21d12
  0 files updated, 0 files merged, 3 files removed, 0 files unresolved

We update to commit 1 to avoid keeping 2, 3, and 4 visible with inhibit

  $ sl goto 11b76ecbf1d49ab485207f46d8c45ee8c96b1bfb
...
changesets
  ...
  $ sl up --hidden d5895ab3603770985bf7ab04bf25c0da2d7e08ab # --hidden because directaccess works only with hashes
  3 files updated, 0 files merged, 0 files removed, 0 files unresolved
  $ mkcommit k 202
  $ sl rebase -d remote/master
  ...
  $ echo more >> k
  $ sl amend
  $ sl unhide c34ae580ee12e8c648afba30a093690a6e018dac
