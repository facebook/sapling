...
test rust clone
  ...
  $ export LOG=commands::commands::clone
...
Test rust clone
  ...
  TRACE commands::commands::clone: performing rust clone
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: enter
  TRACE clone_metadata{repo="test-repo"}: commands::commands::clone: fetching lazy commit data and bookmarks
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: exit
   INFO get_update_target: commands::commands::clone: enter
   INFO get_update_target: commands::commands::clone: return=None
   INFO get_update_target: commands::commands::clone: exit
...
Test cloning failures
  ...
  TRACE commands::commands::clone: performing rust clone
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: enter
  TRACE clone_metadata{repo="test-repo"}: commands::commands::clone: fetching lazy commit data and bookmarks
  ERROR clone_metadata{repo="test-repo"}: commands::commands::clone: error=Injected clone failure
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: exit
...
Test that we get an error when not specifying a destination directory and running in plain mode
  ...
  TRACE commands::commands::clone: performing rust clone
   INFO clone_metadata{repo="test-repo-notquite"}: commands::commands::clone: enter
  TRACE clone_metadata{repo="test-repo-notquite"}: commands::commands::clone: fetching lazy commit data and bookmarks
   INFO clone_metadata{repo="test-repo-notquite"}: commands::commands::clone: exit
   INFO get_update_target: commands::commands::clone: enter
   INFO get_update_target: commands::commands::clone: return=None
   INFO get_update_target: commands::commands::clone: exit
...
Can clone eagerepo without scheme:
  ...
  TRACE clone_metadata{repo="test-repo"}: commands::commands::clone: fetching lazy commit data and bookmarks
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: exit
   INFO get_update_target: commands::commands::clone: enter
   INFO get_update_target: commands::commands::clone: return=Some((HgId("9bc730a19041f9ec7cb33c626e811aa233efb18c"), "master"))
   INFO get_update_target: commands::commands::clone: exit
  Checking out 'master'
  5 files updated
...
Can pick bookmark or commit using -u:
  ...
  TRACE clone_metadata{repo="test-repo"}: commands::commands::clone: fetching lazy commit data and bookmarks
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: exit
   INFO get_update_target: commands::commands::clone: enter
   INFO get_update_target: commands::commands::clone: return=Some((HgId("f585351a92f85104bff7c284233c338b10eb1df7"), "f585351a92f85104bff7c284233c338b10eb1df7"))
   INFO get_update_target: commands::commands::clone: exit
  ...
  TRACE clone_metadata{repo="test-repo"}: commands::commands::clone: fetching lazy commit data and bookmarks
   INFO clone_metadata{repo="test-repo"}: commands::commands::clone: exit
   INFO get_update_target: commands::commands::clone: enter
   INFO get_update_target: commands::commands::clone: return=Some((HgId("26805aba1e600a82e93661149f2313866a221a7b"), "stable"))
   INFO get_update_target: commands::commands::clone: exit
  Checking out 'stable'
  3 files updated
...
Default to "tip" if selectivepulldefault not available.
  ...
  Server has no 'banana' bookmark - trying tip.
   INFO get_update_target: commands::commands::clone: return=Some((HgId("9bc730a19041f9ec7cb33c626e811aa233efb18c"), "tip"))
   INFO get_update_target: commands::commands::clone: exit
  Checking out 'tip'
  5 files updated
