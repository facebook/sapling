...
test source directory is renamed
  ...
  │
  o  3203ffa6f201 A
Tofix: merge the changes of foo and foo1 to bar
  $ hg subtree merge --from-path foo1 --to-path bar
  searching for merge base ...
  merge base: 290b1475463b
  ...
  $ hg go -C .
  1 files updated, 0 files merged, 0 files removed, 0 files unresolved
Tofix: merge the change of bar to foo1
...
test both source and dest directories are renamed
  ...
  │
  o  0a81f6dee7d1 A
tofix: merge the changes of foo and foo1 to bar1
  $ hg subtree merge --from-path foo1 --to-path bar1
  searching for merge base ...
  merge base: 11377da2bd86
  0 files updated, 0 files merged, 0 files removed, 0 files unresolved
  (subtree merge, don't forget to commit)
  $ hg diff
  $ hg go -C .
  0 files updated, 0 files merged, 0 files removed, 0 files unresolved
tofix: merge the change of bar1 and bar to foo1
