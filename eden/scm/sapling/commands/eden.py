...
class HgServer:
    ...
    def _gen_options(self) -> bytes:
        from sapling.ext.remotefilelog import constants, shallowutil
    ...
    #  `sapling.commands.eden.cmd(...)`: Expected `(Request) -> None` for 1st
    ...
    def _do_prefetch(self, request: Request) -> None:
        ...
        # pyre-fixme[16]: `localrepo.localrepository` has no attribute `fileservice`.
