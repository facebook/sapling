...
coreconfigitem("copytrace", "dagcopytrace", default=False)
...
coreconfigitem("format", "use-segmented-changelog", default=True)
...
coreconfigitem("log", "use-committer-date", default=False)
...
coreconfigitem("merge", "max-distance", default=None)
