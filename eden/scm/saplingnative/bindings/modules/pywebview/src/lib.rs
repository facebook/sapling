...
pub fn init_module(py: Python, package: &str) -> PyResult<PyModule> {
    ...
    m.add(
         ...
         "open_isl",
         py_fn!(py, open_isl(
             repo_cwd: &str, port: i32, no_open: bool, json_output: bool, foreground: bool, force: bool, kill: bool, platform: &str, slcommand: &str, slversion: &str, server_cwd: &str, nodepath: &str, entrypoint: &str,
         )))?;
    Ok(m)
}
