...
VmFlags: rd wr mr mw me ac'''
        self.assertEqual(
            5 * 4096,
            stats.total_private_dirty(stats.parse_smaps(smaps)))

    @unittest.skipUnless(
        sys.platform == 'linux',
        '/proc/self/smaps only exists on Linux')
...
line at end
    ...
    def test_total_private_dirty_returns_None_if_unknown_value_format(self):
        ...
        self.assertIs(None, stats.total_private_dirty([{
            b'Private_Dirty': b'4096 B'
        }]))
